    ...
    try {
        ...
        if (process.env.GEMINI_CLI_COMMAND) {
            ...
            try {
                ...
                const fullMessage = chatInstruction + characterSection + userProfileSection + systemPromptSection + historyContext + '【現在のメッセージ】\\n' + message;
...
app.post('/api/settings', (req, res) => {
    ...
    console.log('[Settings] POST - Updated:', syncedSettings);
